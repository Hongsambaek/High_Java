...
public class T01ArrayListTest {
	...
	public static void main(String[] args) {
		...
		// Default Capacity = 10 (기본 저장공간을 10으로 설정)
		...
		System.out.println("첫 번째 데이터를 YYY로 데이터로 변경한 후 : " + list1);

		// 데이터 삭제하기
		list1.remove(0);
		System.out.println("첫 번재 데이터 삭제 후 : " + list1);

		list1.remove("bbb");
		System.out.println("bbb데이터 삭제 후 : " + list1);
		System.out.println("-------------------------------------------------");

		list1.remove(new Integer(111));
		System.out.println("111데이터 삭제 후 : " + list1);
		...
		// indexOf(비교객체) => 리스트에 '비교객체' 를 찾아 존재하는 인덱스 값을 반환한다.
		// 존재하지 않으면 -1을 반환한다.
