...
public class T06TreeSetTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("K이전 데이터 : " + ss1);
		System.out.println("K이전 데이터(기준값 포함) : " + ts.headSet("K", true));
		...
		System.out.println("K이후 데이터 : " + ss2);
		System.out.println("K이후 데이터(기준값 포함) : " + ts.headSet("K", false));
