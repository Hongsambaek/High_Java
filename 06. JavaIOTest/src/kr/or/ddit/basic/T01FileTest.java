...
public class T01FileTest {
	public static void main(String[] args) throws IOException {
		...
		//   => 디렉토리와 디렉토리 사이 또는 디렉토리와 파일명 사이의 구분문자 '\'를 사용하거나
		//	   '/'를 사용할 수 있다.
		...
		File file4 = new File(".\\D_Other\\test\\..", "test.txt"); // 상대 경로
		...
		/*
		 	...
		 	2. mkdirs() => 중간의 경로가 없으면 중간의 경로도 새롭게 만든 후 마지막 디렉토리를
		 				=> 만들어준다.
		 			=> 위 두 메소드 모두 만들기를 성공하면 true, 실패하면 false로 반환함.
